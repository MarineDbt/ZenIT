...
public class OccasionalParticipantsUI extends BaseUI implements ActionListener {
	...
	public OccasionalParticipantsUI(AbstractPersistenceHandlerFactory factory, User currentUser, Event currentEvent, Activity currentActivity) {
		...
		ArrayList<User> participants = facade.getMembers(currentEvent); 
		...
		numberfollow.setText(String.valueOf(participants.size()));
		...
		JLabel lblid = new JLabel(participants.get(i).getID());
		...
		JLabel lblfirstname = new JLabel(participants.get(i).getFirstname());
		...
		JLabel lbllastname = new JLabel(participants.get(i).getLastname());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("return")) {
			ActivityListEventUI frame = new ActivityListEventUI(factory, user,this.currentActivity);
