...
public class AjouterAccessoireUI extends JFrame implements ActionListener {
	 ...
	 * Create the frame.
	 */
	public AjouterAccessoireUI(AbstractPersistenceHandlerFactory maFactory) {
		super("Ajout accessoire");
		factory = maFactory;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("valid")){
			RoomFacade facade = new RoomFacade(factory);
	    	 boolean result = facade.createAccessory(tNom.getText());
	    	
	    	 
	    	 if(result)
	    	 {
	    		 dispose();
	    		 OkUI OK = new OkUI("L'accessoire a bien été ajouté");
	    		 OK.setVisible(true);
	    	 }
	    	 else
	    	 {
