...
public class UpdateCatUI extends JFrame implements ActionListener {
	...
	public UpdateCatUI(Category theOldCategory, AbstractPersistenceHandlerFactory myFactory, User user) {
		
		oldCategory = theOldCategory;
		factory = myFactory;
		...
		textField = new JTextField(oldCategory.getName());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("Valider"))
		{
			...
			boolean result = facade.modifyCategory(oldCategory, textField.getText());
			if (result) 
			{
				DisplayCatUI catFrame = new DisplayCatUI(factory, currentUser);
				catFrame.setVisible(true);
				OkUI frame = new OkUI("La catégorie a bien été modifiée");
